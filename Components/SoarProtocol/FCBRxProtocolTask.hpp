 ...
 * Description        : Protocol task, specific to FCBRx
 ******************************************************************************
 */
#ifndef SOAR_FCBRXPROTOCOL_HPP_
#define SOAR_FCBRXPROTOCOL_HPP_
...
/* Class ------------------------------------------------------------------*/
class FCBRxProtocolTask : public ProtocolTask
{
public:
    static FCBRxProtocolTask &Inst()
    {
        static FCBRxProtocolTask inst;
        return inst;
    }
...
protected:
    static void RunTask(void *pvParams) { FCBRxProtocolTask::Inst().Run(pvParams); } // Static Task Interface, passes control to the instance Run();
...
private:
    FCBRxProtocolTask();                                     // Private constructor
    FCBRxProtocolTask(const FCBRxProtocolTask &);            // Prevent copy-construction
    FCBRxProtocolTask &operator=(const FCBRxProtocolTask &); // Prevent assignment
};

#endif // SOAR_FCBRxPROTOCOL_HPP_
